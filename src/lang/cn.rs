...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Successful", "云联远程成功"),
        ("Connected, waiting for image...", "云联远程已连接，等待画面传输..."),
        ("Name", "名称"),
        ("Type", "类型"),
        ("Modified", "修改时间"),
        ("Size", "大小"),
        ...
        ("Failed to connect to rendezvous server", "连接云联远程服务器失败"),
        ...
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [云联远程] 服务开启。"),
